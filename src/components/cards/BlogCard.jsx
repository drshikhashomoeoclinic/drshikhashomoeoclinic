...
export default function BlogCard({ post }) {
  return (
    <article className="group glass-card glass-card-hover overflow-hidden">
      <div className="relative aspect-[16/10] overflow-hidden bg-gradient-to-br from-white/85 via-clinic-cream to-emerald-50 bg-cover bg-center" style={post.image ? { backgroundImage: `url(${post.image})` } : undefined}>
