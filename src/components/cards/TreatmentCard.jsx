...
function ServiceMedia({ service }) {
  ...
  if (image && !imageFailed) {
    return (
      <span className="grid size-[72px] place-items-center overflow-hidden rounded-2xl bg-emerald-50 shadow-sm">
        <img
  ...
  return (
    <span className="grid size-[72px] place-items-center rounded-2xl bg-emerald-50 text-clinic-emerald shadow-sm">
      <Icon size={32} />
    </span>
  );
}
