  ...
  return (
    <footer className="border-t border-slate-100 bg-clinic-ink text-white">
      <div className="container-lux grid gap-10 py-14 md:grid-cols-[1.2fr_.8fr_.8fr_.8fr]">
        ...
        <div><h3 className="font-bold">Opening Hours</h3><p className="mt-4 text-white/70">{site.hours}</p><p className="mt-2 text-white/70">{site.address}</p><p className="mt-2 text-white/70">{site.emergencyText || 'Emergency: nearest hospital or emergency care.'}</p></div>
